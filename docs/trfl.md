...
### [`gen_distribution_ops.project_distribution_eager_fallback(support, weights, new_support, method, name, ctx)`](https://github.com/deepmind/trfl/blob/master/trfl/gen_distribution_ops.py?l=89)<!-- RULE: gen_distribution_ops.project_distribution_eager_fallback .code-reference -->
