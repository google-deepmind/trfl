...
def log_probs_from_logits_and_actions(policy_logits, actions):
  ...
  policy_logits.get_shape().assert_has_rank(3)
  actions.get_shape().assert_has_rank(2)
...
def from_logits(behaviour_policy_logits,
  ...
  # The rest will be checked by vtrace_from_action_log_probs.
  behaviour_policy_logits.get_shape().assert_has_rank(3)
  target_policy_logits.get_shape().assert_has_rank(3)
  actions.get_shape().assert_has_rank(2)

  with tf.name_scope(
      name,
      values=[
          behaviour_policy_logits, target_policy_logits, actions, discounts,
